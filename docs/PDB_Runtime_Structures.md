...
Comprehensive documentation of all C++ runtime structures identified from the Fallout: New Vegas Xbox 360 PDB symbols (`tools/pdb_types_full.txt`) and implemented in the memory dump analyzer.
...
| 4 | 4 | uint8 | cFormType | Form type identifier (e.g., 0x2A=NPC_, 0x45=DIAL/INFO) |
