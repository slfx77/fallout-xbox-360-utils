...
internal class PackedGeomStreamInfo
{
    ...
    public StreamSemantic GetSemantic(int half4Index = -1)
    {
        return (Type, UnitSize) switch
        {
            ...
            (16, 8) when BlockOffset == 20 => StreamSemantic.Normal, // VERIFIED: unit-length, matches PC
            (16, 8) when BlockOffset == 32 => StreamSemantic.Tangent, // unit-length
            (16, 8) when BlockOffset == 40 => StreamSemantic.Bitangent, // unit-length
            (16, 8) when BlockOffset == 8 => StreamSemantic.Unknown, // Unknown auxiliary data
