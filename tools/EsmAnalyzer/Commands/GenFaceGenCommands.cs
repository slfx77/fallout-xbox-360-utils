...
/// <summary>
///     Commands for FaceGen CTL file processing (C# code generation from si.ctl).
/// </summary>
public static class GenFaceGenCommands
{
    /// <summary>
    ...
    private static string GenerateCSharp(CtlData ctl)
    {
        ...
        sb.AppendLine("// Auto-generated by EsmAnalyzer gen-facegen from si.ctl");
