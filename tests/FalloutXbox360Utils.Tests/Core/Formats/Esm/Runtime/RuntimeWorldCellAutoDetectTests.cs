...
public sealed class RuntimeWorldCellAutoDetectTests
{
        ...
        int cellShift)
    {
        ...
        WriteUInt16BE(data, worldOffset + 156 + worldShift, unchecked((ushort)12));
        WriteUInt16BE(data, worldOffset + 158 + worldShift, unchecked((ushort)8));
...
public sealed class RuntimeWorldCellDumpRegressionTests(SampleFileFixture samples)
{
    ...
    private static void AssertReleaseBetaFamilyProbe(
        (RuntimeWorldCellLayoutProbeResult? Probe, int WorldCellMapCount, int CellEntryCount, int RuntimeCellSignalCount) result)
    {
        Assert.NotNull(result.Probe);
    ...
    private static async Task<(RuntimeWorldCellLayoutProbeResult? Probe, int WorldCellMapCount, int CellEntryCount, int RuntimeCellSignalCount)> ProbeDumpAsync(string dumpPath)
    {
