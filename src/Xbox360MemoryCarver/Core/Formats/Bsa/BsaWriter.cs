...
public sealed class BsaWriter : IDisposable
{
    ...
    public void Write(Stream stream)
    {
        ...
        var totalFolderNameLength = (uint)sortedFolders.Sum(f => f.Name.Length + 2); // +1 for length byte, +1 for null
        ...
        var fileNamesOffset = fileRecordsOffset + totalFolderNameLength + (fileCount * FileRecordSize);
