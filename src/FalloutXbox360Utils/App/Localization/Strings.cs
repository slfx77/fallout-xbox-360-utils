...
public static class Strings
{
    ...
    public static string Status_ParsingRecords => Get("Status_ParsingRecords");
    ...
    public static string Status_DataBrowserReady => Get("Status_DataBrowserReady");
    public static string Status_SearchIndexReady => Get("Status_SearchIndexReady");
    ...
    public static string Status_ParsingWorldData => Get("Status_ParsingWorldData");
    ...
    public static string Dialog_ParseFailed_Title => Get("Dialog_ParseFailed_Title");
    ...
    public static string Status_ProcessingProgress(int current, int total) =>
        GetFormat("Status_ProcessingProgress", current, total);

    public static string Status_ScanningPercent(int percent, int filesFound) =>
        GetFormat("Status_ScanningPercent", percent, filesFound);
    ...
    public static string Status_FilesSelected(int selected, int total) =>
        GetFormat("Status_FilesSelected", selected, total);
    ...
    public static string Status_ScanningEsmRecordsPercent(int percent) =>
        GetFormat("Status_ScanningEsmRecordsPercent", percent);

    public static string Status_ParsedRecords(int count) => GetFormat("Status_ParsedRecords", count);
