...
public static class SubrecordSchemaRegistry
{
    ...
    private static Dictionary<SchemaKey, SubrecordSchema> BuildSchemaRegistry()
    {
        ...
        // HCLR - Hair Color - stored as big-endian XBGR, needs byte-swap like XCLL colors
        ...
        RegisterSimple4Byte(schemas, "RCLR", "Region Color"); // REGN - color value (BE XBGR)
        ...
        // WATR DNAM (196 bytes) - Water Visual Data
        // Colors at bytes 40-51 stored as big-endian XBGR, need byte-swap like XCLL
        schemas[new SchemaKey("DNAM", "WATR", 196)] = new SubrecordSchema(
            // Bytes 0-39: 10 floats
            ...
            // Bytes 40-51: 3 colors (big-endian XBGR, need swap)
            F.UInt32("ShallowColor"), F.UInt32("DeepColor"), F.UInt32("ReflectionColor"),
            // Bytes 52-55: Unused
            F.Padding(4),
            // Bytes 56-195: 35 floats
        ...
        // Xbox 360 stores colors as big-endian XBGR, PC expects little-endian RGBX.
        // Despite xEdit showing wbByteColors (R,G,B,Unused), they ARE stored as 32-bit values
        // that need byte-swapping: Xbox 00 45 46 2F -> PC 2F 46 45 00
        ...
        // wbStruct(XESP, [wbFormIDCk('Reference', ...), wbInteger('Flags', itU8), wbUnused(3)])
        // CRITICAL: Flags is UInt8, NOT UInt32! Byte-swapping as UInt32 corrupts the enable state.
        ...
        // XCLP - Linked Reference Color (8 bytes = 2 × colors)
        // Colors stored as big-endian XBGR, need byte-swap like XCLL
    ...
    private static void RegisterDataSubrecordSchemas(Dictionary<SchemaKey, SubrecordSchema> schemas)
    {
        ...
        // Color is big-endian XBGR on Xbox, needs byte-swap like other colors
        ...
        // Colors are big-endian XBGR on Xbox, need byte-swap like XCLL
