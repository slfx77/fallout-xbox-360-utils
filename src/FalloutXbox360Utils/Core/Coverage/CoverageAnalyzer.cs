...
public static class CoverageAnalyzer
{
        ...
        string pdbGlobalsPath)
    {
        ...
        var gameModule = MinidumpAnalyzer.FindGameModule(minidump);
        if (gameModule == null)
        {
        ...
        var peSections = EsmEditorIdPeParser.EnumeratePeSections(accessor, result.FileSize, minidump, gameModule);
