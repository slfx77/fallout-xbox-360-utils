...
/// <summary>
///     Item-related schemas (WEAP, ARMO, AMMO, ALCH, MISC, CONT, KEYM).
/// </summary>
internal static class SubrecordItemSchemas
{
    /// <summary>
    ...
    internal static void Register(Dictionary<SubrecordSchemaRegistry.SchemaKey, SubrecordSchema> schemas)
    {
        ...
        // DATA - WEAP (15 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "WEAP", 15)] = new SubrecordSchema(
            F.Int32("Value"),
            F.Int32("Health"),
            F.Float("Weight"),
            F.Int16("Damage"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("CRDT", null, 16)] = new SubrecordSchema(
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("VATS", "WEAP", 20)] = new SubrecordSchema(
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DNAM", "ARMO", 12)] = new SubrecordSchema(
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "ARMA", 12)] = new SubrecordSchema(
            F.Int32("Value"),
        ...
        // DATA - AMMO (13 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "AMMO", 13)] = new SubrecordSchema(
            F.Float("Speed"),
            F.UInt8("Flags"),
            F.Padding(3),
            F.UInt32("Value"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DAT2", null, 20)] = new SubrecordSchema(
            F.Padding(8),
            F.UInt32("Value1"),
            F.Padding(4),
            F.UInt32("Value2"))
        ...
        // DATA - ALCH (4 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "ALCH", 4)] = new SubrecordSchema(F.Float("Weight"));
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "MISC", 8)] = new SubrecordSchema(
            F.Int32("Value"),
            F.Float("Weight"))
        {
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("CNTO", null, 8)] = new SubrecordSchema(
            F.FormId("Item"),
            F.Int32("Count"))
        {
        ...
        // DATA - CONT (5 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "CONT", 5)] = new SubrecordSchema(
            F.UInt8("Flags"),
            F.Float("Weight"))
        {
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("SNAM", "CONT", 4)] = SubrecordSchema.Simple4Byte("Sound FormID");
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "KEYM", 8)] = new SubrecordSchema(
            F.Int32("Value"),
            F.Float("Weight"))
        {
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "BOOK", 10)] = new SubrecordSchema(
            F.UInt8("Flags"),
            F.Int8("Skill"),
            F.Int32("Value"),
            F.Float("Weight"))
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "IMOD", 8)] = new SubrecordSchema(
            F.UInt32("Value"),
            F.Float("Weight"))
        {
        ...
        // DATA - PROJ (84 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "PROJ", 84)] = new SubrecordSchema(
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("NAM2", "PROJ")] = SubrecordSchema.ByteArray;
        ...
        // DATA - EXPL (52 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "EXPL", 52)] = new SubrecordSchema(
            F.Float("Force"),
            F.Float("Damage"),
            F.Float("Radius"),
            F.FormId("Light"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("LVLO", null, 12)] = new SubrecordSchema(
            F.UInt16("Level"),
            F.Padding(2),
            F.FormId("Entry"),
            F.UInt16("Count"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DEST", null, 8)] = new SubrecordSchema(
            F.Int32("Health"),
            F.UInt8("Count"),
            F.UInt8("Flags"),
            F.Padding(2))
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DSTD", null, 20)] = new SubrecordSchema(
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "DEBR")] = SubrecordSchema.ByteArray;
        ...
        // DATA - RCPE (16 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "RCPE", 16)] = new SubrecordSchema(
            F.Int32("Skill"),
            F.UInt32("Level"),
            F.FormId("Category"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("RCOD", null, 8)] = new SubrecordSchema(
            F.FormId("Item"), F.UInt32("Count"))
        {
        ...
        // DATA - LIGH (32 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "LIGH", 32)] = new SubrecordSchema(
            F.Int32("Time"),
            F.UInt32("Radius"),
            F.UInt32("Color"),
            F.UInt32("Flags"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("FNAM", "LIGH", 4)] = SubrecordSchema.Simple4Byte("Light Flags");
        schemas[new SubrecordSchemaRegistry.SchemaKey("SNAM", "LIGH", 4)] = SubrecordSchema.Simple4Byte("Sound FormID");
    }
}
