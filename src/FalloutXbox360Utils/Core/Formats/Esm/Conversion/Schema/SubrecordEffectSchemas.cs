...
/// <summary>
///     Effect-related schemas (MGEF, ENCH, SPEL, INGR, PERK).
/// </summary>
internal static class SubrecordEffectSchemas
{
    /// <summary>
    ...
    internal static void Register(Dictionary<SubrecordSchemaRegistry.SchemaKey, SubrecordSchema> schemas)
    {
        ...
        // DATA - MGEF (72 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "MGEF", 72)] = new SubrecordSchema(
            F.UInt32("Flags"),
            F.Float("BaseCost"),
            F.FormId("AssocItem"),
            F.Int32("MagicSchool"),
        ...
        // ENIT - ENCH (16 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("ENIT", "ENCH", 16)] = new SubrecordSchema(
            F.UInt32("Type"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("SPIT", "SPEL", 16)] = new SubrecordSchema(
            F.UInt32("Type"),
            F.UInt32("Cost"),
            F.UInt32("Level"),
            F.UInt8("Flags"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("ENIT", "INGR", 8)] = new SubrecordSchema(
        ...
        // DATA - INGR (4 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "INGR", 4)] = new SubrecordSchema(F.Float("Weight"))
        {
        ...
        // DATA - EFSH (200 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "EFSH", 200)] = new SubrecordSchema(
            F.UInt8("Flags"),
            F.Padding(3),
        ...
        // DATA - EFSH (224 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "EFSH", 224)] = new SubrecordSchema(
            F.UInt8("Flags"),
            F.Padding(3),
            F.UInt32("MembraneSourceBlendMode"),
            F.UInt32("MembraneBlendOperation"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "EFSH", 308)] = new SubrecordSchema(
            F.UInt8("Flags"),
            F.Padding(3),
            F.UInt32("MembraneSourceBlendMode"),
            F.UInt32("MembraneBlendOperation"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("CSTD", null, 92)] = new SubrecordSchema(
            F.UInt8("DodgeChance"),
            F.UInt8("LRChance"),
            F.Padding(2),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "IPCT", 24)] = new SubrecordSchema(
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "IPDS", 48)] = new SubrecordSchema(
            F.FormId("Stone"),
            F.FormId("Dirt"),
            F.FormId("Grass"),
            F.FormId("Glass"),
        ...
        // DATA - ADDN (4 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "ADDN", 4)] = new SubrecordSchema(F.Int32("NodeIndex"))
        {
