...
/// <summary>
///     Actor-related schemas (NPC_, CREA, RACE, FACT, CLAS).
/// </summary>
internal static class SubrecordActorSchemas
{
    /// <summary>
    ...
    internal static void Register(Dictionary<SubrecordSchemaRegistry.SchemaKey, SubrecordSchema> schemas)
    {
        ...
        // ========================================================================
        schemas[new SubrecordSchemaRegistry.SchemaKey("ACBS", null, 24)] = new SubrecordSchema(
            F.UInt32("Flags"),
            F.UInt16("Fatigue"),
            F.UInt16("BarterGold"),
            F.Int16("Level"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("AIDT", null, 20)] = new SubrecordSchema(
            F.UInt8("Aggression"),
            F.UInt8("Confidence"),
            F.UInt8("Energy"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DNAM", "RACE", 8)] =
        ...
        // DATA - RACE (36 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "RACE", 36)] = new SubrecordSchema(
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("HNAM", "RACE")] = SubrecordSchema.FormIdArray;
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("PNAM", "RACE", 4)] =
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("UNAM", "RACE", 4)] =
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("HNAM", "NPC_", 4)] = SubrecordSchema.Simple4Byte("Hair FormID");

        // LNAM - NPC_ Hair Length (4 bytes = float)
        schemas[new SubrecordSchemaRegistry.SchemaKey("LNAM", "NPC_", 4)] =
        ...
        // DATA - NPC_ (11 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "NPC_", 11)] = new SubrecordSchema(
            F.Int32("BaseHealth"),
            F.UInt8("Strength"),
            F.UInt8("Perception"),
            F.UInt8("Endurance"),
        ...
        // DATA - CREA (17 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "CREA", 17)] = new SubrecordSchema(
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("XNAM", "FACT", 12)] = new SubrecordSchema(
            F.FormId("Faction"),
            F.Int32("Modifier"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("CRVA", "FACT", 20)] = new SubrecordSchema(
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "CLAS", 28)] = new SubrecordSchema(
            F.Int32("TagSkill1"),
            F.Int32("TagSkill2"),
            F.Int32("TagSkill3"),
            F.Int32("TagSkill4"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("NAM5", "BPTD")] = new SubrecordSchema(F.UInt32("TextureCount"))
        {
            ExpectedSize = 0,
        ...
        // DATA - RGDL (14 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("DATA", "RGDL", 14)] = new SubrecordSchema(
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("RAFD", null, 60)] = SubrecordSchema.FloatArray;

        // RAPS - Ragdoll Pose Matching (24 bytes)
        schemas[new SubrecordSchemaRegistry.SchemaKey("RAPS", null, 24)] = new SubrecordSchema(
            F.UInt16("Bone0"),
            F.UInt16("Bone1"),
            F.UInt16("Bone2"),
            F.UInt8("Flags"),
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("RAFB")] = new SubrecordSchema(F.UInt16("Bone"))
        {
            ExpectedSize = -1,
        ...
        schemas[new SubrecordSchemaRegistry.SchemaKey("XRGD")] = new SubrecordSchema(
            F.UInt8("BoneId"),
            F.Padding(3),
            F.Vec3("Position"),
            F.Vec3("Rotation"))
