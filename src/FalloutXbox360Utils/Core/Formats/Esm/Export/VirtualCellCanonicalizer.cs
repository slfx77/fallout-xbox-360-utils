...
// Skeleton-based overloads accept the lightweight CellSkeleton from
// CrossDumpSourceProjection so the canonicalizer can run after the heavy CellRecord
// has been released. The bodies mirror the CellRecord versions exactly — the
// byte-identical parity is enforced by VirtualCellCanonicalizerParityTests.
