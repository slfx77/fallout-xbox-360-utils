...
internal static class RuntimeRaceProbe
{
    ...
    [
        ...
        new("FullName", 44, 1, RuntimeReaderFieldProbe.FieldCheck.BSStringT, 2),
        ...
        new("DefaultVoiceMale", 1228, 2, RuntimeReaderFieldProbe.FieldCheck.PointerToForm, 2),
        new("DefaultVoiceFemale", 1232, 2, RuntimeReaderFieldProbe.FieldCheck.PointerToForm, 2),
        new("OldRace", 1236, 2, RuntimeReaderFieldProbe.FieldCheck.PointerToFormType, 2,
            (byte)0x0C)
    ];
