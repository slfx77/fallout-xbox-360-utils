...
internal static class RuntimeEffectProbe
{
    ...
    [
        ...
        new("FullName", 52, 1, RuntimeReaderFieldProbe.FieldCheck.BSStringT, Weight: 2),
        ...
        new("Light", 112, 1, RuntimeReaderFieldProbe.FieldCheck.PointerToForm, Weight: 2),
        new("Explosion", 132, 1, RuntimeReaderFieldProbe.FieldCheck.PointerToForm, Weight: 2),
