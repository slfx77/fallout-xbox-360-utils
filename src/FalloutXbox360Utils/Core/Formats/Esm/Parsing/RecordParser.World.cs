...
public sealed partial class RecordParser
{
    ...
    public List<CellRecord> ReconstructCells()
    {
        ...
        var cellWorldMap = _scanResult.CellToWorldspaceMap;
        var cellToRefrMap = _scanResult.CellToRefrMap;
        ...
        foreach (var land in _scanResult.LandRecords)
        {
...
#pragma warning restore S3267
    ...
    /// </summary>
    private static void LinkCellsToWorldspaces(List<CellRecord> cells, List<WorldspaceRecord> worldspaces)
    {
