...
public static class CsvReportGenerator
{
    ...
    public static string GenerateDialogueCsv(List<ReconstructedDialogue> dialogues, Dictionary<uint, string> lookup)
    {
        var sb = new StringBuilder();
        sb.AppendLine(
            "RowType,FormID,EditorID,TopicFormID,TopicName,QuestFormID,QuestName,SpeakerFormID,SpeakerName,PreviousInfoFormID,Endianness,Offset,ResponseNumber,ResponseText,EmotionType,EmotionName,EmotionValue");
    ...
    {
        var sb = new StringBuilder();
        sb.AppendLine("RowType,FormID,EditorID,Name,ArmorRating,Value,Weight,Health,ModelPath,Endianness,Offset");
    ...
    public static string GenerateAmmoCsv(List<ReconstructedAmmo> ammo, Dictionary<uint, string> lookup)
    {
        var sb = new StringBuilder();
        sb.AppendLine(
            "RowType,FormID,EditorID,Name,Speed,Value,ClipRounds,Flags,ProjectileFormID,ProjectileName,ModelPath,ProjectileModelPath,Endianness,Offset");
    ...
    public static string GenerateDialogTopicsCsv(List<ReconstructedDialogTopic> topics, Dictionary<uint, string> lookup)
    {
        var sb = new StringBuilder();
        sb.AppendLine(
            "RowType,FormID,EditorID,Name,TopicType,TopicTypeName,Flags,QuestFormID,QuestName,ResponseCount,Endianness,Offset");
