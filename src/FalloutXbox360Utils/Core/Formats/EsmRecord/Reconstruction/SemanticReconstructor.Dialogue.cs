...
public sealed partial class SemanticReconstructor
{
    ...
    /// </summary>
    private byte? DetectDialFormType(List<ReconstructedDialogTopic> topics)
    {
        var knownDialFormIds = new HashSet<uint>(topics.Select(t => t.FormId));
        var formTypeCounts = new Dictionary<byte, int>();
    ...
    /// </summary>
    private static Dictionary<uint, int> BuildDialogueFormIdIndex(List<ReconstructedDialogue> dialogues)
    {
    ...
    private Dictionary<uint, TopicDialogueNode> CreateTopicDialogueNodes(
        Dictionary<uint, List<ReconstructedDialogue>> infosByTopic,
        List<ReconstructedDialogTopic> topics,
    ...
    private void CreateOrphanTopicNodes(
        List<ReconstructedDialogue> unlinkedInfos,
        Dictionary<uint, QuestDialogueNode> questTrees,
    ...
    /// </summary>
    private static TopicDialogueNode CreateSyntheticTopicNode(IGrouping<uint, ReconstructedDialogue> group)
    {
        var infoNodes = group
